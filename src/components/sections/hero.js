...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Shreyas Shivakumar Kasetty</h2>;
  ...
  const four = (
    <>
      <p>
        ...
        backend systems. Currently, I’m focused on building agent based LLM applications and
        end-to-end full stack applications at{' '}
